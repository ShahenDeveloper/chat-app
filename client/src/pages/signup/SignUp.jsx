...
function SignUp() {
  return (
    <div className=' flex flex-col items-center justify-center min-w-96 mx-auto'>
      ...
      <GenderCheckBox/>
      <a href="#" className=' text-sm hover:underline hover:text-blue-500 mt-2 inline-block'>Already have account</a>

      <div>
          <button className='btn btn-block btn-sm mt-3 border border-slate-700'>Sign Up</button>
        </div>
      </form>
      </div>
    </div>
