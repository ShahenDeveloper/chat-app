        ...
        <div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
            ...
            <form>
              ...
              <label className='label'>
                ...
                <input type="text" placeholder='1234' className='w-full input input-bordered h-10'/>
              </div>
              <a href="#" className=' text-sm hover:underline hover:text-blue-500 mt-2 inline-block'>Don't have account</a>
              <div>
